...
- Наблюдения по методам:
  - TextRank демонстрирует наибольшую разделимость (более высокие Jaccard и F1@K), что отражает силу графового ранжирования в улавливании контекстных связей.
