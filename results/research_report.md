...
- **Jaccard Index**: `J(A,B) = |A∩B| / |A∪B|`
  ...
  - Значения 0.25-0.56 указывают на умеренные различия
...
1. **Умеренные различия в ключевых словах**:
   - Jaccard Index находится в диапазоне 0.25-0.56
...
2. **Лексико-стилистические признаки дают слабые-умеренные сигналы**:
   - Jaccard/Harmonic в диапазоне 0.25-0.56 — умеренные различия
...
4. **Влияние модели синтетики**:
   ...
   - Лексические различия варьируются: DeepSeek показывает наибольшие различия по TextRank (Harmonic=0.52)
...
| Модель | Метод | Jaccard | Harmonic | Интерпретация |
|--------|-------|---------|----------|---------------|
| Qwen | TextRank | 0.250 | 0.400 | Умеренные различия |
| DeepSeek | TextRank | 0.351 | 0.520 | Более заметные различия |
| GPTOSS | TextRank | 0.299 | 0.460 | Умеренные различия |

**Вывод**: Лексические различия умеренные, недостаточны для надежной детекции в одиночку.
